# Generated by Django 6.0 on 2025-12-13 15:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medical_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='diagnoses', to='records.medicalhistory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('medical_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allergies', to='records.medicalhistory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route', models.CharField(default='oral', help_text='e.g., oral, IV, topical', max_length=50)),
                ('start_date', models.DateField()),
                ('end_date', models.DateField(blank=True, null=True)),
                ('purpose', models.TextField()),
                ('side_effects', models.TextField(blank=True)),
                ('is_active', models.BooleanField(default=True)),
                ('medical_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medications', to='records.medicalhistory')),
        ...
        migrations.AddField(
            ...
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_histories', to='records.patient'),
        ),
    ]
